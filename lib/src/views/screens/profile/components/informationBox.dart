    ...
    return ExtendedContainer(
      ...
      child: Column(
        children: [
          ...
          profileInfoBox(title: "lavigne10@outlook.com"),
          ...
          profileInfoBox(title: ConstString.changeLanguage, icon: Icons.flag_outlined, trailing: Icon(Icons.arrow_drop_down_sharp),
          onPresse: (){Get.dialog(ChangeLangageDialog());}),
        ],
      ),
    );
  }
  Widget profileInfoBox({@required String title, IconData icon, Widget trailing,Function onPresse}) {
    return InkWell(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(title, style: componentMenuStyle,),
            ...
            Stack(
              ...
              children: [
                Divider(),
                icon!=null?  Positioned(child: Icon(icon, color: blackFont, size: 4.0.h,), bottom: 5..h, left: -10.0.w,) : Container()
